# Generated by Django 4.2.13 on 2024-07-15 07:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_type', models.CharField(choices=[('presonal', 'Личная задача'), ('team', 'Задача для команды')], default='personal', max_length=10)),
                ('changeable', models.IntegerField(choices=[(0, 'Не готов'), (1, 'Завершена')], default=0, help_text='0 - Не готов, 1 - Завершена', verbose_name='Состояние задачи')),
